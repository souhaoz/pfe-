        ...
        <div class="position-relative">
            ...
            <section class="section-hero section-shaped my-0">
                ...
                <div class="container shape-container d-flex" >
                    <div class="col px-0" style="margin-top:20%;">
                        <!--<button data-v-5d92c2be=""
                                v-on:click="changeColor()"
                                type="button"
                                class="elevation-0 v-btn v-btn--floating v-btn--fixed v-btn--top theme--dark grey"
                                style="top: 96px;"><div class="v-btn__content">
                                    <i
                                        data-v-5d92c2be=""
                                        aria-hidden="true"
                                        class="v-icon mdi mdi-settings theme--dark">
                                    </i>Change Color
                                    </div>
                        </button>-->
                        <div class="row mt-5">
                            <div class="col-lg-12">
                                <h1 class="display-3  text-white">Plateforme
                                    <span>d'échange d'information</span>
                                </h1>
                                <p class="lead  text-white">La plateforme assure l'échange et même la gestion de tout le systéme </p>
                                <div class="row justify-content-center mt-5">
                                    <div class="col-md-3">
                                        <base-button tag="a"
                                                     class="mb-3 mb-sm-2 btn-block"
                                                     v-bind:style="btnStyles"
                                                     icon="fa fa-user-o">
                                            <router-link style="color:white" to="/login" >Client</router-link>
                                        </base-button>
                                    </div>
                                    <div class="col-md-3">
                                        <base-button tag="a"
                                                     ...
                                                     class="mb-3 mb-sm-2 btn-block"
                                                     style="background-color:#26bee6 ;border:none; "
                                                     icon="fa fa-user">
                                            <router-link style="color:white" to="/login">Gestionnaire</router-link>
                                        </base-button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center justify-content-around stars-and-coded" style="margin-top: 20%">
                            <div class="col-sm-4">
                            </div>
                            <div class="col-sm-4 mt-5 mt-sm-0 text-right">
                                ...
                                <a href="https://www.creative-tim.com" target="_blank" title="Creative Tim - Premium Bootstrap Themes and Templates">
                                    <img src="./../assets/img-theme/linedata-logo.png" class="ml-3" style="height: 30px;">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods:{
            changeColor: function(){
                if(this.bgColor== "#f76424")
                    this.bgColor= "#fd7c00"
                else
                    this.bgColor= "#f76424"
                alert("Msg from function 'changeColor'")
            }
        },
        computed: {
            btnStyles() {
